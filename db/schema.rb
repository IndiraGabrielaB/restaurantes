...
ActiveRecord::Schema.define(version: 2021_10_26_012013) do
  ...
  create_table "puntajes_restaurantes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["puntaje_id"], name: "index_puntaje_restaurantes_on_puntaje_id"
    t.index ["restaurante_id"], name: "index_puntaje_restaurantes_on_restaurante_id"
    t.index ["usuario_id"], name: "index_puntaje_restaurantes_on_usuario_id"
  end
  ...
  add_foreign_key "puntaje_restaurantes", "puntajes"
  add_foreign_key "puntaje_restaurantes", "restaurantes"
  add_foreign_key "puntaje_restaurantes", "usuarios"
